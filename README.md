...
backend files, prerequisites documentation, Docker setup, and JavaScript code—were
generated by OpenAI Codex to ensure a secure implementation and protect against
potential vulnerabilities. Running the chatbots incurs costs, and I wanted to avoid
creating a superficially working but insecure login.

The main HTML pages—such as the homepage and the chatbot interface—are entirely my
original work. This approach reflects that the assignment’s focus was on HTML
